...
export const metadata: Metadata = {
  title: "Export Specifications: Fresh Tomato Grade-A | B2B Bulk Supply",
  description: "B2B Technical specifications for Fresh Export Tomatoes. Grade A, Turning/Breaking red maturity, plastic/corrugated box crates, firm-textured parameters, and logistics terms.",
};

export default function TomatoProductPage() {
  const product = siteConfig.products.tomato;
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        "@type": "ListItem",
        "position": 3,
        "name": "Nashik Tomato Supplier",
        "item": "https://nashikfruitandvegetable.com/tomato-supplier-from-nashik/"
      }
    ]
  };
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-4 text-xs">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <span className="text-slate-500">5-7 Days from order confirmation</span>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <span className="text-slate-500">Phytosanitary Cert, Certificate of Origin, FSSAI certified packing</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-7 space-y-8">
            <div className="space-y-4">
              <div className="inline-flex items-center space-x-2 bg-emerald-50 text-primary px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider border border-emerald-100">
                ...
                <span>Export Quality Assured</span>
              </div>
              ...
              <p className="text-slate-600 text-xs leading-relaxed font-sans">
                Our export tomatoes are strictly graded for uniformity in size, shape, and maturity. We harvest them at the "Turning" or "Breaking Red" color index stage to ensure they reach global destinations in Dubai, Sri Lanka, and Malaysia with maximum firmness, excellent shelf life, and zero cracking.
              </p>
            </div>
            ...
            <div className="bg-[#022c22] text-white p-6 rounded-2xl border border-emerald-800 shadow-md flex flex-col md:flex-row items-center justify-between gap-4 card-shadow">
              <div className="space-y-1 text-center md:text-left">
                <h3 className="font-bold text-sm uppercase tracking-wider text-emerald-300">Request Bulk Shipment Quote</h3>
                <p className="text-[11px] text-slate-300 font-sans">Connect to discuss shipping routes, packaging specifications, and pricing variables.</p>
              </div>
